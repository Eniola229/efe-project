...
if(isset($_POST["btn_update"]))
{
    if($_POST["password"]!='')
    {
      ...
      $q1="UPDATE `tbl_teacher` SET `staff_id`='$staff_id',`tfname`='$tfname',`tlname`='$tlname',`classname`='$classname',`subjectname`='$subjectname',`temail`='$temail',`tgender`='$tgender',`tdob`='$tdob',`tcontact`='$tcontact',`taddress`='$taddress',`password`='$pass' WHERE `id`='".$_GET['id']."'";
        }
        else
        {
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Lecturer Management</li>
                    </ol>
                </div>
            </div>
...
<input type="hidden" name="old_password" class="form-control" value="<?php echo $password;?>">
                                   ...
                                   <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="staff_id" class="form-control" placeholder="Staff ID" id="event" onkeydown="return alphanumericOnly(event);" value="<?php echo $staff_id; ?>" required="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="tcontact" class="form-control" placeholder="Contact Number" id="tbNumbers" minlength="11" maxlength="11" onkeypress="javascript:return isNumber(event)" required="" value="<?php echo $tcontact; ?>">
                                                </div>
                                            </div>
                                        </div>
