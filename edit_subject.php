...
if(isset($_POST["btn_update"]))
{
    extract($_POST);
      ...
      $q1="UPDATE `tbl_subject` SET `subjectname`='$subjectname',`class_id`='$class_id',`course_code`='$course_code' WHERE `id`='".$_GET['id']."'";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="course_code" class="form-control" placeholder="Course Code" id="event" onkeydown="return alphanumeric(event);" value="<?php echo $course_code; ?>" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="subjectname" class="form-control" placeholder="Course Title" id="event" onkeydown="return alpha(event);" value="<?php echo $subjectname; ?>" required="">
                                                </div>
                                            </div>
                                        </div>
