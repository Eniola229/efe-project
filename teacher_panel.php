        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Invigilator Panel</h3> </div>
            ...
            <div class="container-fluid">   
               ...
               <div class="card">
                <h3><i class="fa fa-clock-o"></i> Invigilation Schedule For Today</h3>
                            <div class="card-body">
                                <div class="table-responsive m-t-40">
                                    ...
                                    <?php 
                                    include 'connect.php';
                                  $sql1 = "SELECT * FROM  `allot` WHERE invigilator1='".$_SESSION['id']."' and exam_date='".date('Y-m-d')."' GROUP BY room_id";
                                   ...
                                   $s1 = "SELECT * FROM `exam` WHERE id='".$row['exam_id']."'";
                                    ...
                                    $sres1 = mysqli_fetch_array($sr1); 
                                      ?>
                                        ...
                                        <td style="text-align: left;"><?php echo $sres1['name']; ?></td>
                                            </tr>
                                          <?php } ?>
                                        </tbody>
                                    </table>
