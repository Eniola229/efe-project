            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <select type="text" name="room" id="room" class="form-control"   placeholder="Room" required="">
                                <option value="">--Select Room--</option>
                                    <?php  
                                    $c1 = "SELECT * FROM `room`";
                                    $result = $conn->query($c1);
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <?php  
                                    $c1 = "SELECT * FROM `tbl_teacher` ORDER BY RAND() LIMIT 1";
                                    $result = $conn->query($c1);
                                    $invigilator = $result->fetch_assoc();                                        
                                     ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="inv" id="invigilator" class="form-control"
                                                    value="<?php echo
                                                    $invigilator['tfname'] . '' .
                                                    $invigilator['tlname']; ?>" readonly>
                                                    <input type="hidden" name="inv_id"
                                                    value="<?php echo $invigilator['id']; ?>">
                                    </div>
                                    </div>
                                    </div>
...
$('#class_capacity').keyup(function(){

    var room =  $('#room_capacity').val();
    var class1 =  $('#class_capacity').val();
  
    if (class1 > room) {

       //$('.error').html('<i style="color:red;">class Capacity more than room Capacity. please change</i>');
