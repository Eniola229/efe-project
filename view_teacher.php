        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h2 class="text-primary">Lecturers</h2> </div>
                 ...
                 <div class="card">
                          ...
                          <?php } } ?>
                                <div class="table-responsive m-t-40">
                                    <table id="myTable"  class="table table-bordered table-striped table-condensed table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Staff ID</th>
            ...
            <?php if(isset($useroles)){  if(in_array("edit_teacher",$useroles)){ ?> 
                                                <a href="edit_teacher.php?id=<?=$row['id'];?>"><button type="button" class="btn btn-xs btn-primary" ><i class="fa fa-pencil"></i></button></a>
                                              <?php } } ?>

            <?php if(isset($useroles)){  if(in_array("delete_teacher",$useroles)){ ?> 
                                                <a href="view_teacher.php?id=<?=$row['id'];?>"><button type="button" class="btn btn-xs btn-danger" ><i class="fa fa-close"></i></button></a>
                                              <?php } } ?>
...
<div class="popup popup--icon -primary js_success-popup popup--visible">
  <div class="popup__background"></div>
  <div class="popup__content">
    <h3 class="popup__content__title">
      Success 
    ...
    <p>
      <button class="button button--primary" data-for="js_success-popup">Close</button>
    </p>
  </div>
</div>
