                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="scontact" class="form-control" placeholder="Contact Number" id="tbNumbers" minlength="11" maxlength="11" onkeypress="javascript:return isNumber(event)" required="">
                                                </div>
                                            </div>
                                        </div>
